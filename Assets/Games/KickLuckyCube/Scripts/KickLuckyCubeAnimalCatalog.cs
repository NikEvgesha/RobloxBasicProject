...
namespace RobloxBasicProject.Games.KickLuckyCube
{
    ...
    public static class KickLuckyCubeAnimalCatalog
    {
        private static readonly KickLuckyCubeAnimalCatalogEntry[] Entries =
        {
            ...
            new("kick_rare_horse", "Champ", KickLuckyCubeRarity.Rare, new Color(0.54f, 0.32f, 0.16f), 560, 60, 1.18f, KickLuckyCubeAnimalSource.Kick, ZooPrefab("Champ"), PetIcon("champ")),
            ...
            new("kick_rare_chill", "Chill", KickLuckyCubeRarity.Rare, new Color(0.58f, 0.84f, 1f), 600, 70, 1.16f, KickLuckyCubeAnimalSource.Kick, ZooPrefab("Chill"), PetIcon("chill")),
            ...
            new("epic_shop_crystal_griffin", "Balerina Capuchina", KickLuckyCubeRarity.Epic, new Color(0.24f, 0.86f, 1f), 3200, 115, 1.42f, KickLuckyCubeAnimalSource.EpicShop, BrainrotPrefab("balerina", "Balerina_Rig"), PetIcon("balerina_capuchina")),
            new("epic_shop_neon_hydra", "Tung Tung Sahur", KickLuckyCubeRarity.Legendary, new Color(0.72f, 0.22f, 1f), 5200, 185, 1.52f, KickLuckyCubeAnimalSource.EpicShop, BrainrotPrefab("TungTungSahur", "TungTungSahur_Rig"), PetIcon("tung_tung_sahur")),
            new("epic_shop_sun_kaiju", "Glorbo Fruttodrillo", KickLuckyCubeRarity.Legendary, new Color(1f, 0.66f, 0.08f), 7600, 260, 1.58f, KickLuckyCubeAnimalSource.EpicShop, BrainrotPrefab("GlorboFruttodrillo", "GlorboFruttodrillo_Rig"), PetIcon("glorbo_fruttodrillo")),
